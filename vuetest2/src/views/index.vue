<template>
    ...
    <!--&lt;!&ndash;        <el-menu :default-openeds="['1','3']" :default-active="'1-2'">&ndash;&gt;-->
    ...
    <!--&lt;!&ndash;              <template slot="title"><i class="el-icon-message"></i>选项3</template>&ndash;&gt;-->
    <!--&lt;!&ndash;              <el-menu-item index="1-3-1">选项3-1</el-menu-item>&ndash;&gt;-->
    <!--&lt;!&ndash;              <el-menu-item index="1-3-2">选项3-2</el-menu-item>&ndash;&gt;-->
